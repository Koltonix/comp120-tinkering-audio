...
// Taken from https://gist.github.com/R-WebsterNoble/70614880b0d3940d3b2b741fbbb311a2
...
public static class SaveWavUtil
{
    ...
    public static void Save(string filename, AudioClip clip, bool trim = false)
    {
        ...
        var filepath = Path.Combine(Application.dataPath + "/Generated Clips", filename);
